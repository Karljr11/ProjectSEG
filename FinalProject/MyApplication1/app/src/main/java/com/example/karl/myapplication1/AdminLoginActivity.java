...
public class AdminLoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        databaseServices = FirebaseDatabase.getInstance().getReference("Admin").child(current.getUsername()).child("Services");
    ...
    private void addService() {
        ...
        if(!TextUtils.isEmpty(type)){
            Service service = new Service(type, hourlySalary,0.0);
            databaseServices.child(type).setValue(service);
            edtType.setText("");
